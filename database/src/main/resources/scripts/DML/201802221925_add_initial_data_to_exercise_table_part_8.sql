INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  'KLATA1',
  'Wyciskanie sztangielek',
  'skos górny',
  '/images/wyciskanie_sztangielki_1.jpg;/images/wyciskanie_sztangielki_2.jpg;/images/wyciskanie_sztangielki_3.jpg',
  '/images/klatka_1.png',
  'https://www.youtube.com/watch?v=oKcauOEd0EY',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, naramienny akton przedni, trójgłowy ramienia',
  'dwugłowy ramienia',
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Wyciskanie sztangielek',
  'skos dolny',
  '/images/wyciskanie_sztangielki_dol_1.jpg;/images/wyciskanie_sztangielki_dol_2.jpg;/images/wyciskanie_sztangielki_dol_3.jpg',
  '/images/klatka_1.png',
  'https://www.youtube.com/watch?v=C_BMUU0Uino',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, naramienny akton przedni, trójgłowy ramienia',
  'dwugłowy ramienia',
  ...
  'Jest to bardzo skuteczne ćwiczenie, działające w pierwszej kolejności na dolną część klatki piersiowej. Jest alternatywą dla wyciskania sztangi w skosie dolnym. Ważną rolę odgrywa odpowiednia technika. Plecy powinny przylegać bezpośrednio do ławeczki. Należy zwrócić uwagę, aby ramiona nie pływały, a łokcie nie przybliżały sie do ciała. Kończyny dolne powinny być odpowiednio zablokowane, co jest szczególnie istotne podczas ćwiczeń indywidualnych, bez osoby asekurującej. Ćwiczenie daje również możliwość lepszego rozbudowania wewnętrznej części klatki, bowiem przy wyciskaniu sztangielek do pionu można zbliżać je do siebie, co jest z praktycznych względów niemożliwe kiedy ćwiczy się sztangą. Przy ruchu w dół powinno się niżej opuszczać łokcie. Ważną rolę odgrywa płynny oddech. Serie treningowe powinna poprzedzić solidna rozgrzewka, bądź inne ćwiczenie na omawianą grupę mięśniową.\r\n\r\nĆwiczenie to daje możliwość zmiany ustawienia nadgarstków, przez co pozwala atakować mięśnie pod różnym kątem i w różny sposób. Istotną rolę odgrywa odpowiedni dobór obciążenia. Należy postarać się, aby wziąć taki ciężar, który pozwoli na wykonanie zakładanej serii treningowej. Zamiast chwytu zamkniętego można zastosować chwyt otwarty, czyli tzw. małpi chwyt. Zalecane jest to jednak tylko dla osób zaawansowanych i przy obowiązkowej asekuracji.\r\n\r\nAby zmniejszyć udział przedniego aktonu mięśni naramiennych i tricepsów można ściągnąć łopatki do siebie. Ćwiczenia nie powinny wykonywać osoby mające problemy z krążeniem i ciśnieniem.'
);
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Wyciskanie sztangielek',
  'ławka pozioma leżąc',
  '/images/wyciskanie_sztangielki_plaska_1.jpg;/images/wyciskanie_sztangielki_plaska_2.jpg;/images/wyciskanie_sztangielki_plaska_3.jpg',
  '/images/klatka_1.png',
  'https://www.youtube.com/watch?v=02z5uTM5bRY',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, przedni akton naramiennego, trójgłowy ramienia',
  'dwugłowy ramienia',
  'Złap sztangielki nachwytem, połóż się na ławce poziomej (płaskiej), a stopy postaw stabilnie na podłożu. Ugnij nogi w kolanach tak, aby tworzyły kąt prosty. Kiedy pośladki i plecy będą przylegać ściśle do ławki weź głęboki wdech i wykonaj ruch podobny do wyciskania sztangi wypychając sztangielki ku górze, jednocześnie robiąc wydech. Następnie opuść równym tempem ciężar w taki sposób, aby łokcie znalazły się trochę poniżej poziomu, na którym ułożony jest tułów. W tej fazie pamiętaj o kolejnym wdechu. Łokcie w trakcie całego ćwiczenia powinny być oddalone od tułowia.',
  'Jest to jedno z najlepszych ćwiczeń na rozbudowę klatki piersiowej. Jest alternatywą dla wyciskania sztangi na ławce poziomej. Bardzo ważną rolę odgrywa odpowiednia technika. Należy zwrócić szczególną uwagę, aby plecy przylegały bezpośrednio do ławeczki, a stopy były osadzone pewnie na podłodze (nie kładź ich ugiętych na ławce). Ćwiczenie daje możliwość lepszego rozbudowania wewnętrznej części klatki piersiowej, bowiem przy wyciskaniu sztangielek do pionu można zbliżać je do siebie, co jest z praktycznych względów niemożliwe kiedy ćwiczysz sztangą. Przy ruchu w dół można niżej opuścić łokcie. Ważną rolę odgrywa płynny oddech. Serie treningowe powinna poprzedzić solidna rozgrzewka.\r\n\r\n\r\nĆwiczenie to daje możliwość zmiany ustawienia nadgarstków, przez co pozwala atakować mięśnie pod różnym kątem i w różny sposób. Istotną rolę odgrywa odpowiedni dobór obciążenia. Należy wziąć taki ciężar, który pozwoli na wykonanie zakładanej serii treningowej. Aby zmniejszyć udział przedniego aktonu mięśni naramiennych i tricepsów można ściągnąć łopatki do siebie. Zamiast chwytu zamkniętego można zastosować chwyt otwarty, czyli tzw. małpi chwyt. Zalecane jest to jednak tylko dla osób zaawansowanych i przy obowiązkowej asekuracji.'
);
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Wyciskanie sztangi',
  'skos górny',
  '/images/wyciskanie_sztangi_1.jpg;/images/wyciskanie_sztangi_2.jpg;/images/wyciskanie_sztangi_3.jpg',
  '/images/klatka_1.png',
  'https://www.youtube.com/watch?v=FoP4sLFziF0',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, naramienny akton przedni, trójgłowy ramienia',
  'dwugłowy ramienia',
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Wyciskanie sztangi',
  'skos dolny',
  '/images/wyciskanie_sztangi_dol_1.jpg;/images/wyciskanie_sztangi_dol_2.jpg;/images/wyciskanie_sztangi_dol_3.jpg',
  '/images/klatka_1.png',
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Wyciskanie sztangielek',
  'złączonych młotkowo',
  '/images/IMG_7801.jpg;/images/IMG_7803.jpg',
  '/images/klatka_1.png',
  'https://www.youtube.com/watch?v=G9L8l4N01-k',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, przedni akton naramiennego, trójgłowy ramienia',
  'dwugłowy ramienia',
  'Złap sztangielki nachwytem, nadgarstki ustaw w chwycie młotkowym, złącz hantle ze sobą, połóż się na ławce poziomej (płaskiej), stopy postaw stabilnie na podłożu i ugnij w kolanach tak, aby zginając się tworzyły kąt prosty. Kiedy pośladki i plecy będą przylegać ściśle do ławki weź głęboki wdech i wykonaj ruch wyciskania wypychając sztangielki ku górze, podczas którego wypuszczaj powietrze, następnie opuść równym tempem ciężar do momentu, gdy sztangielki dotkną klatki piersiowej lub nieco przed .W tej fazie pamiętaj o kolejnym wdechu. Łokcie w trakcie całego ćwiczenia powinny być blisko tułowia.',
  'Kolejna odmiana wyciskania hantlami. Znakomite ćwiczenie angażujące środkową część klatki piersiowej. Możesz je wykonywać również na skosie dodatnim oraz ujemnym. Hantle powinny być złączone w każdej fazie ruchu. Ruch wyciskania kończ przed zblokowaniem łokci.'
);
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Siódemkowanie',
  '',
  '/images/IMG_7776.jpg;/images/IMG_7778.jpg;/images/IMG_7782.jpg',
  '/images/klatka_1.png',
  'https://www.youtube.com/watch?v=Ya8F8kcxA2g',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, naramienny akton przedni, trójgłowy ramienia',
  'dwugłowy ramienia',
  'Połóż się na ławce poziomej (płaskiej), stopy postaw stabilnie na podłożu i ugnij w kolanach tak, aby zginając się tworzyły kąt prosty. Złap sztangę nachwytem w równych odstępach od jej środka, następnie zdejmij ją z uchwytów i opuść równym tempem do klatki piersiowej wykonując głęboki wdech (faza negatywna), następnie wyciśnij sztangę do wysokości ok. 1/3 ruchu robiąc wydech, powtórz siedem razy, następnie zacznij wyciskanie od 1/2 ruchu w górę powtarzając siedem razy, na koniec wykonaj siedem pełnych ruchów wyciskania (pamiętając o oddechu).',
  'Podsumowując, na jedną serię tego ćwiczenia składa się 21 powtórzeń – siedem powtórzeń do 1/3 ruchu, siedem powtórzeń od połowy ruchu do końca oraz siedem pełnych ruchów. Ćwiczenie często wykorzystywane na koniec treningu, z małymi ciężarami, jeśli chcesz je wykonać na początku treningu zwróć szczególną uwagę na odpowiednią rozgrzewkę. Pomaga w przełamaniu stagnacji, zwiększa intensywność treningu. Ilość powtórzeń jest kwestią umowną. Istnieje możliwość modyfikacji szerokości uchwytu - im węższy tym bardziej angażuje środkową część klatki i mięśnie trójgłowe ramion. Ważną rolę odgrywa płynny oddech. Ćwiczenie możesz wykonać również na ławce ustawionej pod skosem dodatnim oraz ujemnym. Niezbędna asekuracja.'
);
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'siedząc (butterfly)',
  '/images/motyl_1.jpg;/images/motyl_2.jpg',
  '/images/klatka_6.png',
  'https://www.youtube.com/watch?v=28CLSYRdN28',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, naramienny akton przedni',
  'dwugłowy ramienia',
  ...
  'Jest to jedno z najczęściej stosowanych ćwiczeń rozciągających stosowanych na tę partię mięśniową. Bardzo ważną rolę w omawianym ćwiczeniu odgrywa odpowiednia technika oraz odpowiednie ustawienie wysokości ławeczki tak, aby zaangażowane były w głównym stopniu ćwiczone mięśnie. Ćwiczenie jest szczególnie przydatne przy stosowaniu planów treningowych, w których zamierza się zawrzeć ćwiczenia izolowane. Należy pamiętać, aby nie ciągnąć ciężaru grzbietem. Ważną rolę odgrywa płynny oddech. Przedni akton mięśni naramiennych pracuje słabiej w tym ćwiczeniu niż przy wyciskaniu.'
);
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Rozpiętki na ławce',
  'skos górny / w bramie',
  '/images/rozpietki_1.jpg;/images/rozpietki_2.jpg;/images/rozpietki_3.jpg',
  '/images/klatka_2.png',
  'https://www.youtube.com/watch?v=MHwNtPCmuZg',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, naramienny akton przedni, dwugłowy ramienia',
  'trójgłowy ramienia, mięśnie przedramion, ramienny',
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Rozpiętki na ławce',
  'skos dolny / w bramie',
  '/images/rozpietki_dol_1.jpg;/images/rozpietki_dol_2.jpg;/images/rozpietki_dol_3.jpg',
  '/images/klatka_2.png',
  'https://www.youtube.com/watch?v=6r7T0z2e4eY',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, naramienny akton przedni, dwugłowy ramienia',
  'trójgłowy ramienia, mięśnie przedramion, ramienny',
...
INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  ...
  'Pompki na poręczach',
  '',
  '/images/pompki_1.jpg;/images/pompki_2.jpg',
  '/images/klatka_4.png',
  'https://www.youtube.com/watch?v=CAUw3o9x-Ag',
  'piersiowy większy',
  'piersiowy mniejszy, naramienny akton przedni, trójgłowy ramion, równoległoboczny, dźwigacz łopatki, najszerszy grzbietu, obły większy',
  'czworoboczny część dolna',
  'Stań pomiędzy dwoma poręczami tak, aby ich rączki były skierowane prostopadle do Ciebie. W początkowej fazie wskocz na poręcze i unieś swój ciężar na rękach, prostując je, w taki sposób, aby znalazły się wzdłuż Twojego tułowia. Wykonaj ruch w dół, uginając ręce w łokciach i robiąc tzw. pompkę (od której pochodzi nazwa ćwiczenia). Przy ruchu do dołu weź wdech. Podczas ruchu powrotnego wyprostuj ręce, jednocześnie robiąc wydech. Jest to ćwiczenie trudne, wymagające odpowiedniego doświadczenia. Łokcie w trakcie całego ćwiczenia powinny być nieco oddalone od tułowia. Tułów powinien być lekko pochylony.',
  'Jest to ćwiczenie bardzo dobrze rozwijające dolne części klatki piersiowej. Należy zwrócić uwagę na to, aby w głównym stopniu pracowały mięśnie piersiowe (nie trójgłowe ramion). Wpływ na ten fakt ma odpowiednia pozycja podczas wykonywania ćwiczenia i odpowiednie oddalenie łokci od tułowia. Im bardziej jest się pochylonym do przodu, tym bardziej pracuje klatka, a im bardziej pionowo tym bardziej pracuje triceps. Aby odciążyć ich pracę można również nie prostować rąk do końca. Przy swobodnym wykonywaniu zamierzonych powtórzeń, można dołączyć do pasa dodatkowe obciążenie.'
);

INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  'KLATA16',
  'Ściąganie/krzyżowanie linek',
  'wyciągu górnego w bramie',
  '/images/sciaganie_1.jpg;/images/sciaganie_2.jpg',
  '/images/klatka_5.png',
  'https://www.youtube.com/watch?v=AvRNnmspLyQ',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, dźwigacz łopatki, równoległoboczny, naramienny akton przedni, najszerszy grzbietu',
  'dwugłowy ramienia, trójgłowy ramienia, mięśnie przedramion, ramienny',
  'Stań między dwoma linkami górnego wyciągu w bramie, pochyl się trochę do przodu i ugnij lekko nogi w kolanach. Weź wdech, chwyć rączki wyciągów i ściągnij linki przed siebie, do wewnątrz (do dołu), wykonując jednocześnie wydech. Przy ruchu powrotnym ponownie weź wdech. W ćwiczeniu stosuj mniejsze ciężary, w celu lepszej kontroli pełnego zakresu ruchów. W końcowej fazie, dobrze jest przez chwilę zatrzymać linki wyciągu, w celu lepszego napięcia mięśni. Łokcie w trakcie całego ćwiczenia powinny być skierowane na zewnątrz (daleko od ciała)..',
  'Jest to bardzo skuteczne ćwiczenie rozciągające mięśnie klatki piersiowej. Należy zwrócić szczególną uwagę na dobór odpowiedniego ciężaru, ponieważ ćwiczenie wymaga dokładności i płynności ruchów. Powinny być one pełne, lecz nie należy przesadzać z ruchem w tył. Łokcie przez cały czas ćwiczenia powinny być zablokowane. Ważną rolę odgrywa odpowiednia postawa. Zaleca się unikanie wszelkich ruchów tułowiem. Najlepiej jest, aby ćwiczenie wykonywane było przed lustrem. Przedni akton mięśni naramiennych pracuje słabiej niż przy wyciskaniu. Ważną rolę odgrywa płynny oddech. Jest to ćwiczenie izolowane i nadaje sie do wstępnego zmęczenia mięśni.\r\n\r\nBarki, łokcie oraz dłonie powinny znajdować się na tym samym poziomie, dzięki czemu można łatwiej uniknąć ułożenia ramion w rotacji zewnętrznej, która nie jest dobra dla więzadeł stawów ramiennych. Ćwiczenie pozwala na lepsze zarysowanie mięśni klatki piersiowej. W końcowej fazie można skrzyżować linki wyciągu w celu wykonania większego zakresu ruchów.'
);

INSERT INTO public.exercise(code, title, subtitle, image_url_list, muscle_image_url, video_url, main_muscles, auxiliary_muscles, stabilizers, execution, remarks) VALUES (
  'KLATA17',
  'Ściąganie/krzyżowanie linek',
  'wyciągu dolnego w bramie',
  '/images/sciaganie_dol_1.jpg;/images/sciaganie_dol_2.jpg',
  '/images/klatka_5.png',
  'https://www.youtube.com/watch?v=cQxDrsJMZSU',
  'piersiowy większy',
  'piersiowy mniejszy, zębaty przedni, dźwigacz łopatki, równoległoboczny, przedni akton naramiennego, najszerszy grzbietu',
  'dwugłowy ramion, trójgłowy ramion, zginacze przedramion, ramienny',
  'Stań w małym rozkroku pomiędzy dwoma linkami dolnego wyciągu w bramie, pochyl się trochę do przodu i lekko ugnij nogi w kolanach. Weź wdech, chwyć rączki wyciągów i ściągnij linki przed siebie, do wewnątrz (do góry), robiąc jednocześnie wydech. Wykonując ruch powrotny ponownie weź wdech. W ćwiczeniu stosuj mniejsze ciężary, przez co lepiej można kontrolować pełen zakresu ruchów. W końcowej fazie, dobrze jest przez chwilę zatrzymać linki wyciągu, w celu lepszego napięcia mięśni. Łokcie w trakcie całego ćwiczenia powinny być skierowane na zewnątrz (nieco szerzej niż barki).',
  'Jest to bardzo skuteczne ćwiczenie, rozciągające mięśnie klatki piersiowej. Łokcie w trakcie całego ćwiczenia powinny być nieruchome. Należy zwrócić szczególną uwagę na dobór odpowiedniego ciężaru, ponieważ ćwiczenie wymaga dokładności i płynności ruchów, które powinny być pełne. Ważną rolę odgrywa odpowiednia postawa. Należy unikać wszelkich ruchów tułowiem. Najlepiej jest, aby ćwiczenie wykonywane było przed lustrem, dzięki czemu można mieć pełną kontrolę nad ruchami. Przedni akton mięśni naramiennych pracuje słabiej niż przy wyciskaniu. Ważną rolę odgrywa płynny oddech. Jest to ćwiczenie izolowane i nadaje sie do wstępnego zmęczenia mięśni.\r\n\r\nĆwiczenie to pozwala na lepsze zarysowanie mięśni klatki piersiowej. W końcowej fazie można skrzyżować linki wyciągu w celu wykonania większego zakresu ruchów.'
);